...
public class MainActivity_Sampanna extends AppCompatActivity {
    private Button btn1;
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(validate()) {
                    ...
                    Calculation_Sampanna calc = new Calculation_Sampanna();
                    calc.setHeight(height);
                    calc.setWeight(weight);
                    double valueout = calc.calculate_bmi();
                    if (valueout < 18.5) {
                        Toast.makeText(MainActivity_Sampanna.this, "UnderWeight", Toast.LENGTH_SHORT).show();
                    } else if (valueout >= 18.5 && valueout <= 24.9) {
                        Toast.makeText(MainActivity_Sampanna.this, "Normal Weight", Toast.LENGTH_SHORT).show();
                    } else if (valueout >= 25 && valueout <= 29.9) {
                        Toast.makeText(MainActivity_Sampanna.this, "Over Weight", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(MainActivity_Sampanna.this, "Obesity", Toast.LENGTH_SHORT).show();
                    }
